...
public class DATABASE {
	...
	public static String plantilla ="INSERT INTO contactos(name, nif, email, address, birthdate) VALUES ('<<Nombre>>', '<<NIF>>', '<<Email>>', '<<Direccion>>', '<<Fecha de Nacimiento>>');";
	...
	public User login(String username, String password) {
		...
		try {
			...
			while (rs.next()) { // si encuentra algo entra a while
				...
				user.address = rs.getNString("<<Direccion>>");
