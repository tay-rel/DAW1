...
public class Main_Ejercicios02_03 {
	...
	public static void main(String[] args) {
		...
		/*
		 * for (int i = 0; i < lista.size(); i++) { //compara desde el segundo for (int
		 * j = i; j < lista.size(); j++) {//con el compareTo esta llmando a la condicion
		 * if (lista.get(i).compareTo(lista.get(j))==1) { Estudiante aux=lista.get(i);
		 * lista.set(i, lista.get(j)); lista.set(j, aux); } }
		 * 
		 * }
		 */
